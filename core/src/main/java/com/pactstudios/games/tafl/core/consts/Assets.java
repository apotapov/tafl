...
public class Assets extends GameAssetLoader<TaflLevel> {
    ...
    public static final class Game {
        ...
        public static final String PROFILE_DATA_FILE = "tafl/profile-v1.json";
    ...
    public Assets(SoundService soundService,
        ...
        super(soundService, graphicsService, localeService, levelService);
    ...
    public void loadAssets() {
        ...
        graphicsService.loadTextureAtlases(Assets.Graphics.CREATURE_ATLAS);

        graphicsService.loadFonts(Assets.Fonts.DEFAULT_FONT);
        graphicsService.loadFonts(Assets.Fonts.BLOWHOLE_FONT_GAME, Assets.Fonts.BLOWHOLE_FONT_MENU);

        localeService.load(Assets.Locales.DEFAULT_LOCALE, Assets.Locales.ADDITIONAL_LOCALES);
