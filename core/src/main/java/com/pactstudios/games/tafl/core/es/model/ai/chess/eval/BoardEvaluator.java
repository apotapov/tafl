...
// * *********************************************************************/
//
//package com.pactstudios.games.tafl.core.es.model.ai.chess.eval;
//
...
//                + evalRookBonus(theBoard, fromWhosePerspective) + evalKingTropism(
//                        theBoard, fromWhosePerspective)) >> GRAIN) << GRAIN);
//    }
//
//    /***************************************************************************
//     * PRIVATE METHODS
...
//        long rookboard = theBoard.getBitBoard(Board.ROOK
...
//                }
//
//                // Use the bitboard erasure trick to avoid looking for
//                // additional
...
//            long queenboard = theBoard.getBitBoard(Board.WHITE_QUEEN);
//            if ((queenboard != 0)
//                    && ((queenboard & Board.squareBits[59]) == 0)) {
...
//            }
//
//            // And finally, incite castling when the enemy has a queen on the
//            // board
...
//                    score += 10;
//                } else if (theBoard.getCastlingStatus(Player.SIDE_WHITE
//                        + Board.CASTLE_QUEENSIDE)
//                        && theBoard.getCastlingStatus(Player.SIDE_WHITE
//                                + Board.CASTLE_QUEENSIDE)) {
//                    score -= 24;
//                } else if (theBoard.getCastlingStatus(Player.SIDE_WHITE
...
//
//            // Penalize too-early queen movement
//            long queenboard = theBoard.getBitBoard(Board.BLACK_QUEEN);
//            if ((queenboard != 0)
//                    && ((queenboard & Board.squareBits[3]) == 0)) {
//                // First, count friendly pieces on their original squares
//                int cnt = 0;
...
//                    score += 10;
//                } else if (theBoard.getCastlingStatus(Player.SIDE_BLACK
//                        + Board.CASTLE_QUEENSIDE)
//                        && theBoard.getCastlingStatus(Player.SIDE_BLACK
//                                + Board.CASTLE_QUEENSIDE)) {
//                    score -= 24;
//                } else if (theBoard.getCastlingStatus(Player.SIDE_BLACK
//                        + Board.CASTLE_KINGSIDE)) {
...
//    // If Max has too many pawns on squares of the color of his surviving
//    // bishops,
//    // the bishops may be limited in their movement
//    private int evalBadBishops(Board theBoard, int fromWhosePerspective) {
//        long where = theBoard
//                .getBitBoard(Board.BISHOP + fromWhosePerspective);
//        if (where == 0) {
//            return 0;
//        }
//
...
//        // In chess, two or more pawns on the same file usually hinder each
//        // other,
...
//        if (fromWhosePerspective == Player.SIDE_WHITE) {
//            if (maxMostAdvanced[0] < Math.min(minMostBackward[0],
//                    minMostBackward[1])) {
//                score += (8 - (maxMostAdvanced[0] >> 3))
//                        * (8 - (maxMostAdvanced[0] >> 3));
//            }
//            if (maxMostAdvanced[7] < Math.min(minMostBackward[7],
//                    minMostBackward[6])) {
...
//        } else // from Black's perspective
//        {
//            if (maxMostAdvanced[0] > Math.max(minMostBackward[0],
//                    minMostBackward[1])) {
//                score += (maxMostAdvanced[0] >> 3) * (maxMostAdvanced[0] >> 3);
//            }
//            if (maxMostAdvanced[7] > Math.max(minMostBackward[7],
//                    minMostBackward[6])) {
...
//    private boolean analyzePawnStructure(Board theBoard,
//            int fromWhosePerspective) {
//        // Reset the counters
//        for (int i = 0; i < 8; i++) {
//            maxPawnFileBins[i] = 0;
//            minPawnFileBins[i] = 0;
...
//        int file = square % 8;
//
//        // This pawn is now the most advanced of all white pawns on
//        // its file
...
//        }
//
//        // Look for a "pawn ram", i.e., a situation where a black
//        // pawn
...
//                    // If the black pawn exists, it is the most backward found
//                    // so far
//                    // on its file
//                    int file = square % 8;
