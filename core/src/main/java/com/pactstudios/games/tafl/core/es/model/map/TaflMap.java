package com.pactstudios.games.tafl.core.es.model.map;

import com.pactstudios.games.tafl.core.consts.Constants;
import com.pactstudios.games.tafl.core.es.model.map.cells.CornerCell;
import com.pactstudios.games.tafl.core.es.model.map.cells.KingCell;
import com.pactstudios.games.tafl.core.es.model.map.cells.ModelCell;
import com.pactstudios.games.tafl.core.es.model.map.cells.RegularCell;

public class TaflMap {
    ...
    public void initialize() {
        width = Constants.Map.MAP_DIM;
        height = Constants.Map.MAP_DIM;
        tileSize = Constants.Map.TILE_SIZE;
